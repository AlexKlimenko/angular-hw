(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var AppDeveloperMenuComponent = /** @class */ (function () {
                function AppDeveloperMenuComponent() {
                    this.pages = [
                        { page: 'Home', href: '' },
                ...
                return AppDeveloperMenuComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var LogoSmallComponent = /** @class */ (function () {
                function LogoSmallComponent() {
                    this.logo = {
                        src: './assets/logo.png',
                        title: 'SCOPE',
                        href: '/'
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var clearTimeout = window.clearTimeout, setTimeout = window.setTimeout;
            var SearchBoxComponent = /** @class */ (function () {
                function SearchBoxComponent(searchService, router) {
                ...
                SearchBoxComponent.prototype.clearHint = function () {
                    this.hintList = [];
                    this.hintList.slice(0);
                };
                SearchBoxComponent.prototype.reloadHint = function () {
                    var _this = this;
                    var reloadHint = [];
                    this.searchService.searchPerson(this.searchText, this.hintCount).subscribe(function (data) {
                        reloadHint = data.map(function (person) { return ({
                            text: person.name + " " + person.surname,
                            href: person.url
                        }); });
                    }, function (err) {
                        console.log(err);
                    }, function () { return (_this.hintList = reloadHint); });
                };
                SearchBoxComponent.prototype.showHelper = function () {
                    this.clicked = true;
                };
                SearchBoxComponent.prototype.unshowHelper = function () {
                    this.clicked = false;
                };
                SearchBoxComponent.prototype.onChange = function () {
                    var _this = this;
                    clearTimeout(this.changeInterval);
                    this.changeInterval = setTimeout(function () { return _this.reloadHint(); }, this.interval);
                };
                SearchBoxComponent.prototype.onSelect = function (hintItem) {
                ...
                SearchBoxComponent.prototype.ngOnInit = function () {
                    ...
                    this.subscription = this.router.events.subscribe(function (event) {
                        var searchURL = "/" + _this.controledURL + "?q=";
                        var url = _this.router.url.slice(0, searchURL.length);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchBoxDirective = /** @class */ (function () {
                function SearchBoxDirective(_a) {
                    var element = _a.nativeElement;
                ...
                SearchBoxDirective.prototype.ngOnInit = function () {
                ...
                SearchBoxDirective.prototype.onSearchFocusin = function () {
                    this.toggle();
                };
                SearchBoxDirective.prototype.onDocumentClick = function () {
                    this.toggle();
                };
                SearchBoxDirective.prototype.toggle = function () {
                    var isOpen = document.activeElement === this.elSearch;
            ...
            SearchBoxDirective.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ToolButtonDirective = /** @class */ (function () {
                function ToolButtonDirective() {
                    this.opacity = '1.000';
                    this.default = '0.333';
                    this.stHover = '1';
                    this.stClick = '0.75';
                }
                ToolButtonDirective.prototype.ngOnInit = function () {
                    this.opacity = this.default;
                };
                ToolButtonDirective.prototype.enterHandler = function () {
                    this.opacity = this.stHover;
                };
                ToolButtonDirective.prototype.leaveHandler = function () {
                    this.opacity = this.default;
                };
                ToolButtonDirective.prototype.downHandler = function () {
                    this.opacity = this.stClick;
                };
                ToolButtonDirective.prototype.upHandler = function () {
                    this.opacity = this.stHover;
                };
                return ToolButtonDirective;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var childRouters = [{ path: '**', component: _404_page_component__WEBPACK_IMPORTED_MODULE_3__["NoPageComponent"] }];
            var NoPageModule = /** @class */ (function () {
                function NoPageModule() {
                }
                return NoPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var childRouters = [{ path: 'login', component: _login_page_component__WEBPACK_IMPORTED_MODULE_3__["LoginPageComponent"] }];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchPageComponent = /** @class */ (function () {
                function SearchPageComponent(searchService, activateRoute) {
                    this.searchService = searchService;
                    this.activateRoute = activateRoute;
                    this.subscription = rxjs__WEBPACK_IMPORTED_MODULE_4__["Subscription"].EMPTY;
                    this.reloadContent();
                }
                SearchPageComponent.prototype.reloadContent = function (q) {
                    var _this = this;
                    if (q === void 0) { q = ''; }
                    var reloadPerson = [];
                    this.searchService.searchPerson(q).subscribe(function (data) {
                        reloadPerson = data;
                    }, function (err) {
                        console.log(err);
                    }, function () { return (_this.personList = reloadPerson); });
                };
                SearchPageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.subscription = this.activateRoute.queryParamMap.subscribe(function (queryParams) {
                        var q = queryParams.get('q');
                        _this.reloadContent(q);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserPageComponent = /** @class */ (function () {
                function UserPageComponent(searchService, activatedRoute, router) {
                    this.searchService = searchService;
                    ...
                    this.photos = this.photos.map(function (el, i) { return ({
                ...
                UserPageComponent.prototype.reloadContent = function (id) {
                    var _this = this;
                    if (!id) {
                        this.router.navigate(['**']);
                    }
                    var newPrs;
                    this.searchService.fakeGET_personById(id).subscribe(function (data) { return (newPrs = data); }, function (err) { return console.log(err); }, function () { return (_this.person = newPrs); });
                };
                UserPageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.subscription = this.activatedRoute.queryParamMap.subscribe(function (queryParams) {
                        var id = queryParams.get('id');
                        var searchURL = "/" + _this.controledURL + "?id=";
                        var url = _this.router.url.slice(0, searchURL.length);
                        if (searchURL === url)
                            _this.reloadContent(id);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var childRouters = [{ path: 'user', component: _user_page_component__WEBPACK_IMPORTED_MODULE_5__["UserPageComponent"] }];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PaswordPipe = /** @class */ (function () {
                function PaswordPipe() {
                }
                PaswordPipe.prototype.transform = function (value) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var httpUrl = 'assets/people/people.response.json';
            var fakePing = 250;
            var SearchService = /** @class */ (function () {
                function SearchService(http) {
                    this.http = http;
                }
                SearchService.prototype.fakeGET_personArrBySearch = function (search, count, afterId) {
                    var _this = this;
                    if (search === void 0) { search = ''; }
                    if (count === void 0) { count = 10; }
                    if (afterId === void 0) { afterId = ''; }
                    return this.http
                        .get(httpUrl)
                        .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(fakePing), Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])(function (personArr) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(personArr); }))
                        .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["skipWhile"])(function (person) { return afterId ? person.id !== afterId : false; }), Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["skip"])(afterId ? 1 : 0))
                        .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (person) { return _this.filterPerson(person, search); }))
                ...
                SearchService.prototype.fakeGET_personByUrl = function (url) {
                    return this.http
                        .get(httpUrl)
                        .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(fakePing), Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])(function (personArr) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(personArr); }))
                        .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["find"])(function (person) { return person.url === url; }));
                };
                SearchService.prototype.fakeGET_personById = function (id) {
                    return this.http
                        .get(httpUrl)
                        .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(fakePing), Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])(function (personArr) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(personArr); }))
                        .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["find"])(function (person) { return person.id === id; }));
                };
                SearchService.prototype.filterPerson = function (person, search) {
                    var personStr = ("\n    " + person.name + " " + person.surname + "\n    ").toUpperCase();
                    return search
                        ? search
                            .toUpperCase()
                            .split(' ')
                            .every(function (str) { return personStr.includes(str); })
                        : true;
                };
                SearchService.prototype.searchPerson = function (search, count, afterId) {
                    if (search === void 0) { search = ''; }
                    if (count === void 0) { count = 10; }
                    if (afterId === void 0) { afterId = ''; }
